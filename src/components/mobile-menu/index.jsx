...
const MobileMenu = ({ isOpen = false }) => {
  return (
    <React.Fragment>
      ...
      >
        <nav className="mx-5 my-20 w-full space-y-3 text-lg">
          <NavItem text="Features">
            <div className="flex flex-col space-y-3 pl-3 pt-3 ">
          ...
          <NavItem text="Company">
            <div className="flex flex-col space-y-3 pl-11 pt-3">
          ...
          <NavItem text="About" />
          <div className="absolute bottom-5 left-5 right-5 flex flex-col space-y-3">
            <Button>Login</Button>
